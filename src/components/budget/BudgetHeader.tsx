  ...
  return (
    <div className="mb-6 md:mb-10 flex flex-col gap-2 text-left">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-[12px] md:text-sm font-semibold uppercase tracking-wider text-slate-900">
          Total Budget: {budgetUtils.formatMoney(totalBudget)}
        </span>
      </div>
      <h1 className="text-2xl md:text-4xl font-bold mb-2 tracking-tight text-slate-900">
        Da Nang Family Trip
      </h1>
